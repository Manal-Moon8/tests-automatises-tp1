...
Pour consulter le rapport de couverture HTML, ouvrez le fichier `htmlcov/index.html` dans votre navigateur après avoir exécuté la commande avec l'option `--cov-report=html`.